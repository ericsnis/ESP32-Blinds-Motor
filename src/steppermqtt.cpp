/*
  Blinds stepper motor for ESP32
  2022 EricSnis
  ...
  - Since there are no endstops the program assumes the blinds are closed.
  ...
  - The motor driver is attached to the following pins on the ESP32
    - Driver 1 Input 1 - Arduino 9
    - Driver 1 Input 2 - Arduino 13
    - Driver 1 Input 3 - Arduino 12
    - Driver 1 Input 4 - Arduino 14
    - Driver 2 Input 1 - Arduino 33
    - Driver 2 Input 2 - Arduino 32
    - Driver 2 Input 3 - Arduino 35
    - Driver 2 Input 4 - Arduino 34
    Pins can be changed to suit your particular set up if not using included board design
    Note: GPIO 6-11 are used for flash memory and cannot be used
...
const int LED_Status1 = 25;      // Status LED 1
...
const int Stepper1In1 = 9;       // Test Input pin 1 of stepper driver 1
const int Stepper1In2 = 13;      // Test Input pin 2 of stepper driver 1
const int Stepper1In3 = 12;      // Test Input pin 3 of stepper driver 1
const int Stepper1In4 = 14;      // Test Input pin 4 of stepper driver 1
const int Stepper2In1 = 33;      // Input pin 1 of stepper driver 2
const int Stepper2In2 = 32;      // Input pin 2 of stepper driver 2
const int Stepper2In3 = 35;      // Input pin 3 of stepper driver 2
const int Stepper2In4 = 34;      // Input pin 4 of stepper driver 2
...
const int blindsBacklash = 1024; // How much backlash in the blinds rod
